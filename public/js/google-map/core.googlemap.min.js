function bestdeals_googlemap_init(a,b){
  if(typeof BESTDEALS_GLOBALS.googlemap_init_obj=="undefined")
  {
    bestdeals_googlemap_init_styles()}BESTDEALS_GLOBALS.googlemap_init_obj.geocoder="";
    try{
      var d=a.id;BESTDEALS_GLOBALS.googlemap_init_obj[d]={
        dom:a,markers:b.markers,geocoder_request:false,opt:{
          zoom:b.zoom,
          center:null,
          scrollwheel:false,
          scaleControl:false,
