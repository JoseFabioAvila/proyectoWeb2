...
//Aqui form
pop_up_login  +='   					<form action="#" method="post" action="/login" name="login_form" class="popup_form login_form">';

pop_up_login  +='							<div class="popup_form_field login_field iconed_field icon-user">';
pop_up_login  +='								<input type="text" id="email" name="email" value="" placeholder="Login or Email">	';
pop_up_login  +='	 						</div>';

pop_up_login  +='   						<div class="popup_form_field password_field iconed_field icon-lock">';
pop_up_login  +='   							<input type="password" id="password" name="password" value="" placeholder="Password">';
pop_up_login  +='  							</div>';

pop_up_login  +='							<div class="popup_form_field remember_field">';
pop_up_login  +='								<a href="#" class="forgot_password">Forgot password?</a>';
pop_up_login  +='								<input type="checkbox" value="forever" id="remember" name="remember">';
